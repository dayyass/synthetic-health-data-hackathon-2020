...
class ConvDropoutNet(nn.Module):
    ...
    def __init__(self, in_channels: int, n_classes: int, conv_dropout: float = 0.0, linear_dropout: float = 0.0):
        super().__init__()

        # convolutional layers
        self.conv_1 = ConvDropoutLayer(in_channels=in_channels, out_channels=8, kernel_size=3, dropout=conv_dropout)
        self.conv_2 = ConvDropoutLayer(in_channels=8, out_channels=16, kernel_size=3, dropout=conv_dropout)
        self.conv_3 = ConvDropoutLayer(in_channels=16, out_channels=32, kernel_size=3, dropout=conv_dropout)
        self.conv_4 = ConvDropoutLayer(in_channels=32, out_channels=64, kernel_size=3, dropout=conv_dropout)
        self.conv_5 = ConvDropoutLayer(in_channels=64, out_channels=128, kernel_size=3, dropout=conv_dropout)
...
class ConvBatchNormNet(nn.Module):
    ...
    def __init__(self, in_channels: int, n_classes: int):
        ...
        # convolutional layers
        self.conv_1 = ConvBatchNormLayer(in_channels=in_channels, out_channels=8, kernel_size=3)
        ...
        self.conv_5 = ConvBatchNormLayer(in_channels=64, out_channels=128, kernel_size=3)
